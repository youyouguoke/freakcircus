...
export const metadata: Metadata = {
  ...
  keywords: ["The Doctor", "The Freak Circus Doctor", "Doctor route guide", "circus physician", "memory route", "medical files", "Unnamed Open Ending"],
...
const faqData = [
  ...
  { question: "How do you unlock the Unnamed Open Ending ending?", answer: "Find all 5 medical files, trigger the mirror connection (requires failing his main route once), and select \'Ask about the white room\' in Scene 12." },
