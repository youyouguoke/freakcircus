...
const endings = [
  {
    name: "The Open Ending A (unnamed)",
    character: "Harlequin",
  ...
  },
  {
    ...
    interpretation: "The leading theory is that the Unnamed Open Ending is the 'developer room' — a debug space that became part of the narrative. The description matches standard game engine default environments: white void, single chair, mirror for reflection testing. If true, this ending would break the fourth wall most completely, revealing the circus as a digital construct.",
  },
  {
    name: "Unnamed Open Ending",
    character: "???",
    meaning: "The Unnamed Open Ending ending displays raw hex values before crashing. The hex, when converted to ASCII, reads: 'The show is over. The audience has left. Why are you still here?' This suggests the ending is not corrupted — it is a message from outside the narrative, directed at the player personally.",
