...
export default function EndingsFooter() {
  return (
    <section className="bg-surface py-16 px-4 md:px-16 border-t border-outline/10">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <h2 className="font-[Creepster] text-3xl md:text-5xl text-primary mb-4">
          Some Endings May Still Be Hidden
        </h2>

        <p className="text-on-surface-variant mb-8 max-w-2xl mx-auto">
          Investigate route anomalies, replay corruption, and hidden timeline branches inside the archive.
        </p>
