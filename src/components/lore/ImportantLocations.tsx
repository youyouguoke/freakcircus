...
const locations = [
  ...
  },
  {
    ...
    significance: "Primary setting for Columbina's route and Open Ending C (unnamed) ending",
  ...
  },
  {
    ...
    significance: "Primary setting for The Doctor's route and Unnamed Open Ending ending",
    secrets: "1920s medical equipment, Project Continuity files, window shows different exteriors",
  },
  {
    name: "Basement Stage",
    status: "Corrupted",
    desc: "The Basement Stage is a corrupted location that appears only in the Unnamed Open Ending and certain glitch states. It is described as a performance space beneath the main tent, but its architecture suggests it was built before the tent above it. The stage contains props from performances that never occurred in the game's timeline, including posters for shows with dates that do not exist. The Basement's lighting system flickers in patterns that match Morse code, spelling out phrases like 'NO ONE IS HERE' and 'YOU ARE ALONE'.",
    significance: "Appears in Unnamed Open Ending and corrupted save states",
    secrets: "Props from non-existent performances, Morse code lighting, predates main tent",
  },
  {
    name: "Silent Exit",
    status: "Hidden",
    desc: "The Silent Exit is a door that appears only in the Open Ending C (unnamed) ending. It is described as leading 'outside the circus' but shows only darkness when opened. Some players report hearing their own voice when approaching the Exit, and the door handle matches the player's mouse cursor. The Exit's frame contains carvings that match symbols from the Mirror Hall, suggesting a connection between these two hidden locations. Opening the Exit causes the game to crash on some systems, and data miners found an unused scene showing what is behind it.",
    significance: "Appears in Open Ending C (unnamed) ending",
