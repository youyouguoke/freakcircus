...
const evidence = [
  ...
  { id: '02', item: 'Unnamed Open Ending Description', supports: 'Doctor Awareness Theory', color: 'var(--doctor)', detail: 'The Doctor describes the Unnamed Open Ending in Scene 7 with impossible precision. The description matches a Unity testing environment. If the Doctor is aware of the game\'s engine, he may be aware of the player.' },
