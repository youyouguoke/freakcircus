...
const symbols = [
  ...
  },
  {
    ...
    meanings: [
      ...
      { title: "False Endings", desc: "Every curtain fall marks a scene transition. The game's confirmed ending involves curtains falling, but the confirmed ending 'Missing' the curtain falls. Some community members report unusual curtain behavior in certain scenes, but this is unverified." },
    ],
    appearances: "Appear in every scene transition. Curtain behavior in various scenes.",
  },
];
