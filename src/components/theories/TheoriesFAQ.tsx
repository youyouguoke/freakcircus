...
const faqs = [
  ...
  { q: 'What does the Doctor know?', a: 'The Doctor references endings before they occur and his medical files contain timestamps matching real-world save creation dates. His Scene 7 description of the White Room matches unused files in build 1.04.', link: { label: 'Doctor analysis', href: '/characters/doctor' } },
