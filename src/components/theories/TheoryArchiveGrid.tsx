...
const theories = [
  ...
  },
  {
    ...
    confidence: 0,
    character: "All",
    desc: "With 4 planned endings listed by the developer (not yet in game), some fans theorize they may represent different thematic responses to the circus (acceptance, rejection, transcendence). This is pure speculation — the endings have not been named or described by any official source.",
  ...
  },
  {
    ...
    confidence: 0,
    character: "All",
    desc: "Day 3 is confirmed to be planned but unreleased. Some fans expect it to resolve unanswered questions from Day 1 and 2. The developer has stated the script is complete and programming is in progress. Specific content details have not been officially revealed.",
