...
const connections = [
  ...
  { from: "Circus Does Not Exist", to: "Unnamed Open Ending Is Developer Room", label: "connects to" },
  { from: "The Doctor Is The Observer", to: "Unnamed Open Ending Is Developer Room", label: "references" },
