...
const checklist = [
  { item: "Pierrot Main Route — Open Ending B (unnamed) ending", category: "Route", required: true },
  { item: "Pierrot Silent Route — Open Ending C (unnamed) ending", category: "Route", required: true },
  { item: "Harlequin Main Route — Open Ending A (unnamed) ending", category: "Route", required: true },
  { item: "Harlequin True Route — Unnamed Open Ending", category: "Route", required: true },
  { item: "Doctor Main Route — Unnamed Open Ending ending", category: "Route", required: true },
  { item: "Doctor Memory Route — Unnamed Open Ending ending", category: "Route", required: true },
  { item: "Columbina Main Route — Unnamed Open Ending ending", category: "Route", required: true },
  { item: "Columbina Fractured Route — Unnamed Open Ending ending", category: "Route", required: true },
  { item: "Harlequin Joke Route — Unnamed Open Ending ending", category: "Route", required: false },
  { item: "Unnamed Open Ending ending (if achievable)", category: "Ending", required: false },
  { item: "Unnamed Open Ending ending (if found)", category: "Ending", required: false },
  ...
  { item: "CG #3 — Unnamed Open Ending", category: "CG", required: true },
  { item: "CG #4 — Unnamed Open Ending", category: "CG", required: true },
  { item: "CG #5 — Open Ending C (unnamed) (black screen)", category: "CG", required: true },
  { item: "CG #6 — Unnamed Open Ending", category: "CG", required: false },
  { item: "Achievement: Open Ending B (unnamed)", category: "Achievement", required: true },
  ...
  { item: "Achievement: Open Ending C (unnamed)", category: "Achievement", required: true },
  { item: "Achievement: Unnamed Open Ending", category: "Achievement", required: true },
  { item: "Achievement: Unnamed Open Ending", category: "Achievement", required: false },
