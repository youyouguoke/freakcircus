      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-surface-container border border-outline/20 p-8">
          ...
          <div className="mt-4 text-on-surface-variant text-sm">
            <p>Route Relationship Analysis: The current build has 1 confirmed ending ('Missing'). The developer has planned 4 additional endings. Completion of multiple routes unlocks hidden connections.</p>
          </div>
        </div>
      </div>
    </section>
