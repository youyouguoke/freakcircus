...
const anomalies = [
  ...
  },
  {
    ...
    route: "The Doctor",
    status: "Confirmed",
    desc: "Community reports suggest The Doctor may reference events from other routes. Whether this is intentional or interpretation is unverified in detail — three routes before it becomes accessible.",
  },
  {
    id: "a03",
