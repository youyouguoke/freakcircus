...
const faqs = [
  ...
  { q: 'What is the fastest ending to unlock?', a: 'Grand Finale (Harlequin Main Route) can be completed in approximately 45 minutes on a speed run. Smile For Me (Pierrot Main Route) takes about 50 minutes. Both are available from the start.', link: null },
];
